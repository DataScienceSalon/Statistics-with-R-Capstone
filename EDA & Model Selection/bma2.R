...
bma2 <- function(ames_train) {
  ...
  models[["BIC"]] <- BAS::bas.lm(log(price) ~ log(Lot.Area) + Land.Slope + Year.Built + 
  ...
  models[["AIC"]] <- BAS::bas.lm(log(price) ~ log(Lot.Area) + Land.Slope + Year.Built + 
                                   Year.Remod.Add + Bedroom.AbvGr,
  ...
  models[["EB-global"]] <- BAS::bas.lm(log(price) ~ log(Lot.Area) + Land.Slope + Year.Built + 
                                         Year.Remod.Add + Bedroom.AbvGr,
  ...
  models[["EB-local"]] <- BAS::bas.lm(log(price) ~ log(Lot.Area) + Land.Slope + Year.Built + 
                                        Year.Remod.Add + Bedroom.AbvGr,
                                      data = ames_train, prior = "EB-local", initprobs = "eplogp",
                                      modelprior = uniform(), method = "BAS")
  models[["EB-local"]]$priorDesc <- 'Empirical Bayes (Local)'
  
  models[["g-prior"]] <- BAS::bas.lm(log(price) ~ log(Lot.Area) + Land.Slope + Year.Built + 
                                       Year.Remod.Add + Bedroom.AbvGr,,
  ...
  models[["hyper-g"]] <- BAS::bas.lm(log(price) ~ log(Lot.Area) + Land.Slope + Year.Built + 
                                       Year.Remod.Add + Bedroom.AbvGr,
  ...
  models[["hyper-g-laplace"]] <- BAS::bas.lm(log(price) ~ log(Lot.Area) + Land.Slope + Year.Built + 
                                               Year.Remod.Add + Bedroom.AbvGr,
  ...
  models[["hyper-g-n"]] <- BAS::bas.lm(log(price) ~ log(Lot.Area) + Land.Slope + Year.Built + 
                                         Year.Remod.Add + Bedroom.AbvGr,
  ...
  models[["ZS-null"]] <- BAS::bas.lm(log(price) ~ log(Lot.Area) + Land.Slope + Year.Built + 
                                       Year.Remod.Add + Bedroom.AbvGr,
